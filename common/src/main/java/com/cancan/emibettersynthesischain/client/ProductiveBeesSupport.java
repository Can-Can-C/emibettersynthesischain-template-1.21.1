...
public final class ProductiveBeesSupport {
    ...
    /** EmiStack（蜜蜂品种/蜂笼）的品种 Identifier（占位：未实现 → null）。 */
    public static Identifier beeTypeOf(EmiStack stack) {
        return null;
    }

    /** 蜂笼物品（带内部品种标记）的品种 Identifier（占位：未实现 → null）。 */
    public static Identifier beeTypeOfStack(ItemStack stack) {
        return null;
    }
